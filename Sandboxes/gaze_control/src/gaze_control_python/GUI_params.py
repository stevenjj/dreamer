...
DO_SQUARE_EYE_PRIORITY,       DO_SQUARE_EYE_PRIORITY_STRING 		     = 6,  "Square w/ Eye Priority" # Eye Priority
DO_SQUARE_HEAD_PRIORITY,      DO_SQUARE_HEAD_PRIORITY_STRING 		     = 7,  "Square w/ Head Priority" # Head Priority
TRACK_NEAR_PERSON,	    	  TRACK_NEAR_PERSON_STRING   		         = 8,  "Track Near Person" # Eye Priority
