...
def squares_task(head_square_size_in = 0.3):
	...
	eyes_x.append(single.Waypoint(eye_gaze_length, 0, 0, head_traj_duration))
	eyes_y.append(single.Waypoint(eye_square_size/2.0, 0, 0, head_traj_duration))
	eyes_z.append(single.Waypoint(eye_square_size/2.0 + + hk.Head_Kinematics().l1, 0, 0, head_traj_duration))
...
def eye_constant_head_square(head_square_size_in = 0.3):
	head_gaze_length = 0.7
	head_square_size = head_square_size_in
	...
	eyes_x.append(single.Waypoint(eye_gaze_length*1.01, 0, 0, eye_traj_duration))
	eyes_y.append(single.Waypoint(0, 0, 0, eye_traj_duration))
	eyes_z.append(single.Waypoint(hk.Head_Kinematics().l1, 0, 0, eye_traj_duration))
