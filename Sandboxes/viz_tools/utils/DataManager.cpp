...
// DataManager::DataManager():num_data_(0), socket1_(0), socket2_(0), tot_num_array_data_(0){
...
//     case VECT3:
//     {
//         sejong::Vect3 * tmp_vec3 = (sejong::Vect3*)data_addr_vec_[data_idx];
...
//     case VECT4:
//     {
//         sejong::Vect4 * tmp_vec4 = (sejong::Vect4*)data_addr_vec_[data_idx];
...
//     case QUATERNION:
//     {
//         sejong::Quaternion * tmp_quat = (sejong::Quaternion*)data_addr_vec_[data_idx];
//         if(data_array_size_[data_idx] != 4){
//             printf("[Warning] Array size incorrect: %i th data\n", data_idx);
//         }
