...
/*  rp_->new_arr_channel(mc_eye_left,  "left_eye_ori",  sejong::BLUE, 50, 1., 0.5, 4);  // 50 * 4 = 200 => 2 second tail @ 100 Hz
  ...
  rp_->new_arr_channel(mc_eye_left,  "left_eye_ori",  sejong::BLUE, 100, 1., 0.5, 5);  // 50 * 4 = 200 => 2 second tail @ 100 Hz
  rp_->new_arr_channel(mc_eye_right, "right_eye_ori", sejong::LIME, 100, 1., 0.5, 5);  // 8 * 25 = 200 => 2 second tail @ 100 Hz
  rp_->new_arr_channel(mc_head,      "head_ori",      sejong::RED,  100, 1., 0.5, 5);// 10* 10 = 100 => 1 second tail @ 100 Hz  
