...
const uint32_t speedNeutral = PWM_PERIOD/2;
uint32_t speedInit[12] = {speedNeutral};
...
void motorInit(void) {
    ...
    PWM0_0_LOAD_R = PWM_PERIOD;    // set counter reset values (period)
    PWM0_1_LOAD_R = PWM_PERIOD;
    PWM0_2_LOAD_R = PWM_PERIOD;
    PWM0_3_LOAD_R = PWM_PERIOD;
...
void motorUpdate(uint32_t *speed) {
    PWM0_0_CMPA_R = speed[0];
    PWM0_0_CMPB_R = speed[1];
    PWM0_1_CMPA_R = speed[2];
    PWM0_1_CMPB_R = speed[3];
    PWM0_2_CMPA_R = speed[4];
    PWM0_2_CMPB_R = speed[5];
    PWM0_3_CMPA_R = speed[6];
    PWM0_3_CMPB_R = speed[7];
    PWM1_1_CMPA_R = speed[8];
    PWM1_1_CMPB_R = speed[9];
    PWM1_3_CMPA_R = speed[10];
    PWM1_3_CMPB_R = speed[11];
}
