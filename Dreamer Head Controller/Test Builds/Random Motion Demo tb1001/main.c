...
const uint32_t littleMovePeriodMin_d = 32;   // seconds
const uint32_t littleMovePeriodMax_n = 2;   // seconds
const uint32_t littleMovePeriodMax_d = 3;   // seconds
